...
export const docsComponents: DocsComponentEntry[] = [
  ...
  },
  {
    ...
    "category": "Core & Theme",
    "description": "Interactive panel to adjust blur, transparency, reflection, and fluidity.",
  ...
  },
  {
    ...
    "file": "src/components/liquid-glass/MobilePullToRefresh.tsx",
    "category": "Mobile",
    "description": "Pull-to-refresh wrapper for touch scrolling.",
    "usage": "<MobilePullToRefresh />",
